...
const productSchema = new mongoose.Schema({
  ...
  image: String,
  rating: { type: Number, default: 3.8 },
});
...
const getProductUrl = (product_id) =>
  `https://www.amazon.com/gp/product/ajax/?asin=${product_id}&m=&smid=&sourcecustomerorglistid=&sourcecustomerorglistitemid=&sr=1-1&pc=dp&experienceId=aodAjaxMain`;
