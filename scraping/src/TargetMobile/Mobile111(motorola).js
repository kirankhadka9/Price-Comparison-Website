//Motorola Moto G Play 2023 Unlocked (32gb) - Navy Blue
const axios = require('axios');
const cheerio = require('cheerio');
const url = 'https://www.target.com/p/motorola-moto-g-play-2023-unlocked-32gb-navy-blue/-/A-88084859#lnk=sametab';
